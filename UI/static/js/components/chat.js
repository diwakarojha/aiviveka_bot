...
function setUserResponse(message) {
  ...
  const user_response = `<img class="userAvatar" src='https://diwakarojha.github.io/aiviveka_bot/UI/static/img/userAvatar.jpg'><p class="userMsg">${message} </p><div class="clearfix"></div>`;
...
function getBotResponse(text) {
  ...
  botResponse = `<img class="botAvatar" src="https://diwakarojha.github.io/aiviveka_bot/UI/static/img/sara_avatar.png"/><span class="botMsg">${text}</span><div class="clearfix"></div>`;
  return botResponse;
}
...
function setBotResponse(response) {
  ...
  setTimeout(() => {
    ...
    if (response.length < 1) {
      ...
      const BotResponse = `<img class="botAvatar" src="https://diwakarojha.github.io/aiviveka_bot/UI/static/img/sara_avatar.png"/><p class="botMsg">${fallbackMsg}</p><div class="clearfix"></div>`;
          ...
          if (response[i].text != null) {
            ...
            if (
              ...
              if (!botResponse) {
                ...
                botResponse = `<img class="botAvatar" src="https://diwakarojha.github.io/aiviveka_bot/UI/static/img/sara_avatar.png"/><p class="botMsg">${response[i].text}</p><div class="clearfix"></div>`;
              }
            }
